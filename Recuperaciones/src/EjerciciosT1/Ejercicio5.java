...
public class Ejercicio5 {
    public static void main(String[] args) {
        ...
        Map<String, Double> productos1 = new HashMap<>();
        productos1.put("Manzana", 1.20);
        productos1.put("Pan", 0.80);
        productos1.put("Leche", 1.50);
        productos1.put("Huevos", 2.00);

        List<Map.Entry<String, Double>> listaEntradas = new ArrayList<>(productos1.entrySet());
